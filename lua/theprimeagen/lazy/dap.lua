...
return {
    {
        ...
        config = function()
            ...
            vim.keymap.set("n", "<leader>cbp", function()
                dap.set_breakpoint(vim.fn.input("Breakpoint condition: "))
            end, { desc = "Debug: Set Conditional Breakpoint" })

            dap.adapters.codelldb = {
                type = 'server',
                port = 13000,  -- Can be any available port (ensure it’s free)
                executable = {
                    command = 'codelldb',  -- This is the executable you installed via Mason
                    args = { '--port', '13000' },
                }
            }
...

    {
        ...
        --     vim.keymap.set("n", "<leader>dv", function() toggle_debug_ui("scopes") end,
